        ...
        <form action="{{ store.cart_url }}" method="post" class="visible-when-content-ready" data-store="cart-form" data-component="cart">
            ...
            {% if cart.items %}
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8">
                        ...
                        <div class="shipping-info" style="font-size: 14px; color: #333; margin-top: 15px;">
                            <p><strong>Nosso prazo de produção:</strong> até 15 dias úteis após a confirmação do pedido. O prazo de entrega dos Correios começa a ser contado após o envio do produto.</p>
                        </div>
                    </div>
            ...
            <div id="error-ajax-stock" class="row" style="display: none;">
                <div class="alert alert-warning w-100">
                    {{ "¡Uy! No tenemos más stock de este producto para agregarlo al carrito. Si querés podés" | translate }}<a href="{{ store.products_url }}" class="btn-link ml-1
